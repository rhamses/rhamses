...
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 14)
...
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 17)
WHERE slug LIKE 'beatriz-vidal-%' AND json_extract(meta_values, '$.legacy_posttype') = 'equipe';

UPDATE posts SET meta_values = json_set(meta_values, '$.order', 20)
...
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 5)
WHERE slug IN ('producao-artistica-pt-br', 'artist-management-en-us');

UPDATE posts SET meta_values = json_set(meta_values, '$.order', 6)
...
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 46) WHERE slug = 'tv-globo';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 45) WHERE slug = 'open-ai';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 44) WHERE slug = 'netflix';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 43) WHERE slug = 'audible';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 42) WHERE slug = 'hbo';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 41) WHERE slug = 'nubank';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 40) WHERE slug = 'amazonprimevideo';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 39) WHERE slug = 'paramount';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 38) WHERE slug = 'dudalina';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 37) WHERE slug = 'itau';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 36) WHERE slug = 'tiktok';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 35) WHERE slug = 'tim';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 34) WHERE slug = 'heinken';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 33) WHERE slug = 'spotify';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 32) WHERE slug = 'natura';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 31) WHERE slug = 'betc-havas';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 30) WHERE slug = 'shoptime';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 29) WHERE slug = 'globoplay';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 28) WHERE slug = 'warnerchannel';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 27) WHERE slug = 'disney';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 26) WHERE slug = 'espn';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 25) WHERE slug = 'ccxp';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 24) WHERE slug = 'kwai';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 23) WHERE slug = 'omelete';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 22) WHERE slug = 'comedy';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 21) WHERE slug = 'tag';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 20) WHERE slug = 'star';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 19) WHERE slug = 'mibr';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 18) WHERE slug = 'porta-dos-fundos';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 17) WHERE slug = 'redetv';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 16) WHERE slug = 'band';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 15) WHERE slug = 'recordtv';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 14) WHERE slug = 'gnt';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 13) WHERE slug = 'multishow';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 12) WHERE slug = 'natgeo';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 11) WHERE slug = 'tnt';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 10) WHERE slug = 'logitech';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 9) WHERE slug = 'rennova';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 8) WHERE slug = 'deezer';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 7) WHERE slug = 'livelo';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 6) WHERE slug = 'shein';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 5) WHERE slug = 'familhao';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 4) WHERE slug = 'fan-fever';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 3) WHERE slug = 'farfetch';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 2) WHERE slug = 'herbamed';
UPDATE posts SET meta_values = json_set(meta_values, '$.order', 1) WHERE slug = 'merz';
