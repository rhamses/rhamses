...
SELECT 'Diretores', 'diretores', 'category', (SELECT id FROM taxonomies WHERE slug='categoria' LIMIT 1), 0, 0
WHERE NOT EXISTS (SELECT 1 FROM taxonomies WHERE slug='diretores' AND type='category');
...
INSERT OR IGNORE INTO posts (post_type_id, title, slug, status, meta_values, created_at, updated_at)
SELECT (SELECT id FROM post_types WHERE slug='attachment' LIMIT 1), 'jpeg-optimizer_sk_farra_final_029.jpg', 'attachment-diretores-hugo-moura-en-us', 'published', '{"show_in_menu":false,"menu_options":[],"icon":"line-md:file","mime_type":"image/jpeg","attachment_file":"jpeg-optimizer_sk_farra_final_029.jpg","attachment_path":"https://bucket.farra.media/jpeg-optimizer_sk_farra_final_029.jpg","attachment_alt":"Hugo Moura"}', 1722380215000, 1727188595248
WHERE NOT EXISTS (SELECT 1 FROM posts WHERE slug='attachment-diretores-hugo-moura-en-us');
INSERT OR IGNORE INTO posts (post_type_id, id_locale_code, title, slug, excerpt, body, status, meta_values, published_at, created_at, updated_at)
SELECT (SELECT id FROM post_types WHERE slug='post' LIMIT 1), (SELECT id FROM locales WHERE locale_code='en_US' LIMIT 1), 'Hugo Moura', 'hugo-moura-en-us', '', 'Born in Salvador, Bahia, Hugo Moura is a director, publicist, photographer, and actor. He has lived in Rio de Janeiro for 10 years, where he graduated from the Academia Internacional de Cinema (AIC). With over 800 commercials under his belt, he has created campaigns for major brands such as Coca-Cola, Nivea, Loreal, Uber, among others. Hugo specializes in advertising and fashion films, with a keen eye for photography and aesthetic appeal. He has experience filming with major media personalities, and is a well-rounded director in casting, due to his acting experience, and in his photography skills.', 'published', '{"order":0,"image":"https://bucket.farra.media/jpeg-optimizer_sk_farra_final_029.jpg","language":"enUS","slug":"hugo-moura","videos":"3bafc853-df4f-4193-97e9-c59cc95cdb41","videosHome":null,"videosHomeOrder":null,"fichaTecnica":[],"socialMedia":["https://vimeo.com/dirhugomoura","https://www.imdb.com/name/nm8122831","https://www.instagram.com/hugomourag"],"reel":"3bafc853-df4f-4193-97e9-c59cc95cdb41","posttype":"diretores","legacy_id":"0d85a34d-d056-454f-a657-a9707b7d4213","legacy_posttype":"diretores","images":"[\"https://bucket.farra.media/hugo-moura.png\"]"}', 1722380215000, 1722380215000, 1727188595248
WHERE NOT EXISTS (SELECT 1 FROM posts WHERE slug='hugo-moura-en-us');
INSERT OR IGNORE INTO posts_media (post_id, media_id)
SELECT (SELECT id FROM posts WHERE slug='hugo-moura-en-us' LIMIT 1), (SELECT id FROM posts WHERE slug='attachment-diretores-hugo-moura-en-us' LIMIT 1)
WHERE EXISTS (SELECT 1 FROM posts WHERE slug='hugo-moura-en-us') AND EXISTS (SELECT 1 FROM posts WHERE slug='attachment-diretores-hugo-moura-en-us');
INSERT OR IGNORE INTO posts_taxonomies (post_id, term_id)
SELECT (SELECT id FROM posts WHERE slug='hugo-moura-en-us' LIMIT 1), (SELECT id FROM taxonomies WHERE slug='diretores' AND type='category' LIMIT 1)
WHERE EXISTS (SELECT 1 FROM posts WHERE slug='hugo-moura-en-us') AND EXISTS (SELECT 1 FROM taxonomies WHERE slug='diretores' AND type='category');
UPDATE posts SET meta_values = json_set(meta_values, '$.post_thumbnail_id', (SELECT CAST(id AS TEXT) FROM posts WHERE slug='attachment-diretores-hugo-moura-en-us' LIMIT 1)) WHERE slug='hugo-moura-en-us';
UPDATE posts SET id_locale_code = (SELECT id FROM locales WHERE locale_code='en_US' LIMIT 1) WHERE slug='hugo-moura-en-us' AND id_locale_code IS NULL;
...
WHERE NOT EXISTS (SELECT 1 FROM posts WHERE slug='attachment-diretores-hugo-moura-pt-br');
INSERT OR IGNORE INTO posts (post_type_id, id_locale_code, title, slug, excerpt, body, status, meta_values, published_at, created_at, updated_at)
SELECT (SELECT id FROM post_types WHERE slug='post' LIMIT 1), (SELECT id FROM locales WHERE locale_code='pt_BR' LIMIT 1), 'Hugo Moura', 'hugo-moura-pt-br', '', 'Baiano de Salvador, Hugo Moura é diretor, publicitário e de fotografia, e ator. Mora há 10 anos no Rio de Janeiro, onde formou-se pela Academia Internacional de Cinema (AIC). Com mais de 800 filmes publicitários no currículo, assinou campanhas para grandes marcas como Coca-Cola, Nivea, Loreal, Uber, entre outras. Hugo é especialista em publicidade e fashion films, com grande olhar fotográfico e apelo estético. Tem experiência em filmar com grandes personalidades da mídia, um diretor completo na direção de elenco, pela sua bagagem de ator, e no apelo fotográfico.', 'published', '{"order":0,"image":"https://bucket.farra.media/jpeg-optimizer_sk_farra_final_029.jpg","language":"ptbr","slug":"hugo-moura","videos":"3bafc853-df4f-4193-97e9-c59cc95cdb41","videosHome":null,"videosHomeOrder":null,"fichaTecnica":[],"socialMedia":["https://vimeo.com/dirhugomoura","https://www.imdb.com/name/nm8122831","https://www.instagram.com/hugomourag"],"reel":"3bafc853-df4f-4193-97e9-c59cc95cdb41","posttype":"diretores","legacy_id":"82f475bc-6dfe-4989-b975-f31bf1c352fa","legacy_posttype":"diretores","images":"[\"https://bucket.farra.media/MOSAICO TRABALHOS HUGO MOURA v3.png\"]"}', 1721090136000, 1721090136000, 1727188622574
WHERE NOT EXISTS (SELECT 1 FROM posts WHERE slug='hugo-moura-pt-br');
INSERT OR IGNORE INTO posts_media (post_id, media_id)
SELECT (SELECT id FROM posts WHERE slug='hugo-moura-pt-br' LIMIT 1), (SELECT id FROM posts WHERE slug='attachment-diretores-hugo-moura-pt-br' LIMIT 1)
WHERE EXISTS (SELECT 1 FROM posts WHERE slug='hugo-moura-pt-br') AND EXISTS (SELECT 1 FROM posts WHERE slug='attachment-diretores-hugo-moura-pt-br');
INSERT OR IGNORE INTO posts_taxonomies (post_id, term_id)
SELECT (SELECT id FROM posts WHERE slug='hugo-moura-pt-br' LIMIT 1), (SELECT id FROM taxonomies WHERE slug='diretores' AND type='category' LIMIT 1)
WHERE EXISTS (SELECT 1 FROM posts WHERE slug='hugo-moura-pt-br') AND EXISTS (SELECT 1 FROM taxonomies WHERE slug='diretores' AND type='category');
UPDATE posts SET meta_values = json_set(meta_values, '$.post_thumbnail_id', (SELECT CAST(id AS TEXT) FROM posts WHERE slug='attachment-diretores-hugo-moura-pt-br' LIMIT 1)) WHERE slug='hugo-moura-pt-br';
UPDATE posts SET id_locale_code = (SELECT id FROM locales WHERE locale_code='pt_BR' LIMIT 1) WHERE slug='hugo-moura-pt-br' AND id_locale_code IS NULL;

-- Garante categoria diretores nos posts migrados
INSERT OR IGNORE INTO posts_taxonomies (post_id, term_id)
SELECT p.id, (SELECT id FROM taxonomies WHERE slug='diretores' AND type='category' LIMIT 1)
FROM posts p
...
WHERE json_extract(p.meta_values, '$.legacy_posttype') = 'diretores'
  AND NOT EXISTS (
    SELECT 1 FROM posts_taxonomies px WHERE px.post_id = p.id
      AND px.term_id = (SELECT id FROM taxonomies WHERE slug='diretores' AND type='category' LIMIT 1)
  );
